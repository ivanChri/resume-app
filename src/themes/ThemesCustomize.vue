...
<template>
  ...
  <button @click="modalRef?.open()" class="border-1 cursor-pointer rounded-full w-12 h-12 lg:rounded-md lg:w-25 lg:h-auto p-2 border-gray-400 bg-blue-600 text-white">
    {{ cumpotedDeviceType }}
  </button>
